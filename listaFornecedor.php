...
$suppliers = select("suppliers", null, null, null);
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($suppliers as $supplier) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $supplier['supplier_district']; ?></td>
                                                <td><?= $supplier['supplier_phone']; ?></td>
                                                <td><?= $supplier['supplier_email']; ?></td>
                                                <td width="6%"><?= $supplier['supplier_created_in']; ?></td>

                                                <td class="text-center">
                                                    <a href="editaFornecedor.php?id=<?= $supplier['supplier_id']; ?>" class="btn btn-warning btn-sm">
                                                        <span class="iconify" data-icon="mdi:lead-pencil" data-width="17" data-height="17"></span>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deletar-<?= $supplier['supplier_id']; ?>">
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="deletar-<?= $supplier['supplier_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            ...
                                                            <form action="deleta.php" method="POST">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Deseja excluir o Fornecedor: <strong style="color: red;"><?= $supplier['supplier_name']; ?></strong>? Essa alteração não poderar ser desfeita!
